...
// 예제 ) 안지영 이라는 사람의 속성(특징)을 나열하고 객체를 만들세요
// 객체 정의
// let member = {
//     name: "안지영",
...
// console.log("색깔", member.color);
// console.log("무게", member.weight);
// console.log("코드번호", member.codeNum);
...
// console.log("이름", rabbit.name);
// console.log("색깔", rabbit.color);
// console.log("무게", rabbit.weight);
// console.log("코드번호", rabbit.codeNum);
